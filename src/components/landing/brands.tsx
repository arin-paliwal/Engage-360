const Brands = () => {
    const images = [
        ...
        { id: 10, src: "https://s3-us-west-2.amazonaws.com/s.cdpn.io/557257/4.png" },
        { id: 11, src: "https://s3-us-west-2.amazonaws.com/s.cdpn.io/557257/5.png" },
        { id: 12, src: "https://s3-us-west-2.amazonaws.com/s.cdpn.io/557257/6.png" },
        ...
        <div className="slide-track bg-white dark:bg-black">
          {images.map(image => (
            <div key={image.id} className="slide">
              <img src={image.src} height="100" width="250" alt="" className='bg-white dark:bg-black' />
            </div>
          ))}
        </div>
      </div>
