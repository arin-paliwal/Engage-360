  ...
  <div className="bg-[#181818] text-white">
    <div className="p-6 sm:p-12">
      <div className="flex flex-col gap-6 sm:gap-[6rem] lg:flex-row">
        ...
        <div className="flex flex-col gap-6 xl:flex-row sm:gap-[4rem]">
          <div className="flex flex-col w-full sm:w-[20rem]">
            ...
            <p className="text-[#b1b1b1]">
              Manage your workforce efficiently with Engage360, the ultimate HR
              dashboard for employee management, performance tracking, and
              more.
            </p>
          </div>
          {/* Map */}
        ...
        {/* Links Section */}
        <div className="flex flex-col sm:flex-row gap-6 sm:gap-[4rem]">
