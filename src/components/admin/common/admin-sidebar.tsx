            ...
            <button
              ...
              className={`flex items-center border gap-3 w-full px-3 py-2 text-sm rounded-md transition-colors ${
                state.adminState === item.name
                  ? "bg-lightMode-accentBlue/10 text-lightMode-accentBlue dark:bg-darkMode-accentBlue/10 dark:text-darkMode-accentBlue border-lightMode-accentBlue dark:border-darkMode-accentBlue"
